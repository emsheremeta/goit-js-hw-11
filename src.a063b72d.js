...
function fetchImage(_x, _x2) {
  return _fetchImage.apply(this, arguments);
}

function _fetchImage() {
  _fetchImage = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(name, page) {
    var response;
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.prev = 0;
            _context.next = 3;
            return _axios.default.get("\n        https://pixabay.com/api/?key=27790361-d52fedb5b14fb71941e53259d&q=".concat(name, "&image_type=photo&orientation=horizontal&safesearch=true&page=").concat(page, "&per_page=").concat(perPage));
...
},{"./css/styles.css":"krre","axios":"dZBD","notiflix":"cwzQ"}]},{},["Focm"], null)
//# sourceMappingURL=/goit-js-hw-11/src.a063b72d.js.map