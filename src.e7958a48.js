...
var _notiflix = _interopRequireWildcard(require("notiflix"));
...
var clear = function clear(elems) {
  return _toConsumableArray(elems.children).forEach(function (div) {
    return div.remove();
  });
};
...
function _fetchImages() {
  _fetchImages = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(name, page) {
    var response;
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.prev = 0;
            _context.next = 3;
            return _axios.default.get("https://pixabay.com/api/?key=23580980-4f75151f85975025bb6074227&q=".concat(name, "&image_type=photo&orientation=horizontal&safesearch=true&page=").concat(page, "&per_page=").concat(perPage));
...
function eventHandler(_x3) {
  return _eventHandler.apply(this, arguments);
}

function _eventHandler() {
  _eventHandler = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2(ev) {
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            ...
            console.log(name);
            fetchImages(name, page).then(function (name) {
              console.log("Number of arrays: ".concat(name.hits.length));
              console.log("Total hits: ".concat(name.totalHits));
              var totalPages = Math.ceil(name.totalHits / perPage);
              console.log("Total pages: ".concat(totalPages));

              if (name.hits.length > 0) {
                _notiflix.default.Notify.success("Hooray! We found ".concat(name.totalHits, " images."));

                renderGallery(name);
                console.log("Current page: ".concat(page));
                lightbox();
...
function renderGallery(name) {
  var markup = name.hits.map(function (hit) {
    return "<div class=\"photo-card\">\n      <a class=\"gallery__item\" href=\"".concat(hit.largeImageURL, "\"> <img class=\"gallery__image\" src=\"").concat(hit.webformatURL, "\" alt=\"").concat(hit.tags, "\" loading=\"lazy\" /></a>\n      <div class=\"info\">\n        <p class=\"info-item\">\n          <p><b>Likes</b> <br>").concat(hit.likes, "</br></p>\n        </p>\n        <p class=\"info-item\">\n          <p><b>Views</b> <br>").concat(hit.views, "</br></p>\n        </p>\n        <p class=\"info-item\">\n          <p><b>Comments</b> <br>").concat(hit.comments, "</br></p>\n        </p>\n        <p class=\"info-item\">\n          <p><b>Downloads</b> <br>").concat(hit.downloads, "</br></p>\n        </p>\n      </div>\n    </div>");
  }).join('');
...
loadBtn.addEventListener('click', function () {
  ...
  fetchImages(name, page).then(function (name) {
    ...
    var _document$querySelect = document.querySelector('.gallery').firstElementChild.getBoundingClientRect(),
        cardHeight = _document$querySelect.height;
...
},{"./css/styles.css":"krre","axios":"dZBD","notiflix":"cwzQ","simplelightbox":"yx6k","simplelightbox/dist/simple-lightbox.min.css":"krre"}]},{},["Focm"], null)
//# sourceMappingURL=/goit-js-hw-11/src.e7958a48.js.map